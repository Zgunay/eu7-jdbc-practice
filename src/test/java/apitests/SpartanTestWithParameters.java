...
public class SpartanTestWithParameters {
    ...
    public void beforeclass(){
        baseURI="http://18.233.164.111:8000";
    }
    /*
    ...
    //    final Response response1 = given().accept(ContentType.JSON).when().get("api/spartans/5");
...
//        Response response1 = given().accept(ContentType.JSON).pathParam("id",500)
//                .when().get("/api/spartans/{id}");
//
//       Assert.assertEquals(response1.statusCode(),404); ;
//       Assert.assertTrue(response1.contentType().contains("application/json;charset=UTF-8"));
//       Assert.assertTrue(response1.body().asString().contains("Spartan Not Found"));
